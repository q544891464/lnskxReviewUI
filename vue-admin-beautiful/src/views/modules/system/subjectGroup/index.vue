  ...
  <div class="tenantManagement-container">
    ...
    <vab-query-form>
      <vab-query-form-left-panel :span="10">
        ...
        <el-button
            v-if="$perms('system_subjectgroup_import')"
        ...
        <el-button
            v-if="$perms('system_subjectgroup_export')"
...
<script>
  import { getList, doDelete, doDeleteAll, doExportExcel } from "@/api/system/subjectGroup/SkxSubjectGroupManagementApi";
  import Edit from "./components/SkxSubjectGroupManagementEdit";
  import Import from "./components/SkxSubjectGroupManagementImport";
  ...
  export default {
    name: "SkxSubjectGroupManagement",
