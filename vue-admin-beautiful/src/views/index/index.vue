<template>
  <div class="index-container">
    <el-row>
      <el-col v-if="$perms('system_apply_user')">
        <h1 class="title">申报系统使用流程</h1>
        <div class="spanclasscontent">
          <el-row>
            <el-col :xs="8" :sm="8" :md="8" :lg="4" :xl="4" >
              <div class="center">
                ...
                <div>点击左侧《创建申请表》菜单栏进入成果信息填报页面</div>
              </div>
             </el-col>
              ...
              <div class="center">
                ...
                <div class="next-num2">04</div>
                 
                <div>点击左侧《上传申请表》菜单栏进入论文列表页</div>
              </div>
             </el-col>  
              <el-col :xs="8" :sm="8" :md="8" :lg="4" :xl="4" >
              <div class="center">
                ...
                <div>根据页面提示进行申请表的下载、签字盖章并回传</div>
              </div>
             </el-col>   
             <el-col :xs="8" :sm="8" :md="8" :lg="4" :xl="4" >
              <div class="center">
          ...
          2、提交材料注意事项：
           ...
           ① 1.被评审成果为1篇代表性论文（或著作），同时提供5项以上（含）与该代表性作品相关的研究证明作为支撑。高校科研院所类支撑材料为5篇（部）以上（含）与该代表性作品相关的论文（或著作），其中至少1篇（部）为中国境内发表（或出版）；非高校科研院所类支撑材料为5项以上（含）与该代表性作品相关的研究证明，可以是论文（或著作），也可以是已获得的专利或者已获认证的项目等。未发表论文或未获得认定的项目不在申报范围。将主要代表作品及证明材料合并为一份PDF上传，内容包括论文或著作（论文包括出版期刊封面、目录页、版权页、正文，以外文形式发表的论文，需有中文题目及中文简介）；证明材料（如检索收录情况、被引用次数、会议交流的证明材料、有关部门提供的鉴定意见和取得效益的证明等能证明成果价值的相关证明材料）； <br />②申报表打印并签字盖章后扫描上传系统。
          </div> 
         
         <br />
          3、申报截止日期之后，不能再进行申报信息的修改，请所有操作务必在申报截止日期前进行
          <br />
          <br />
          4、提交的所有申报材料要真实，申报表签字、印章齐全并上传方可生效。
         
          <br />
        </div>
      </el-col>
      <el-col v-if="$perms('system_orginfo_view')">
        <h1 class="title">欢迎进入辽宁省自然科学学术成果奖评审系统</h1>
        请先点击左侧的《单位信息维护》菜单栏完善初评单位信息，并在规定的初评时间内完成成果的初评工作！
      </el-col>
      <el-col v-if="$perms('system_expert_user')">
        <h1 class="title">欢迎进入辽宁省自然科学学术成果奖评审系统</h1>
        请专家先完善个人信息，再进行成果的网评工作！
      ...
      >
        <el-card shadow="never">
          ...
          <div style="text-align: center">
            ...
            <h1 style="font-size: 30px">OPSLI 系统</h1>
          </div>
