    ...
    <el-row>
      <el-col v-if="$perms('system_apply_user')">
        ...
        <div class="spanclasscontent">
          1、点击左侧《创建申请表》菜单栏进入成果信息填报页面→填写信息并提交→保存成功→点击左侧《上传申请表》菜单栏进入论文列表页→根据页面提示进行申请表的下载、签字盖章并回传→申报结束
          <br />
          <br />
          2、提交材料注意事项：① 1.被评审成果为1篇代表性论文（或著作），同时提供5项以上（含）与该代表性作品相关的研究证明作为支撑。高校科研院所类支撑材料为5篇（部）以上（含）与该代表性作品相关的论文（或著作），其中至少1篇（部）为中国境内发表（或出版）；非高校科研院所类支撑材料为5项以上（含）与该代表性作品相关的研究证明，可以是论文（或著作），也可以是已获得的专利或者已获认证的项目等。未发表论文或未获得认定的项目不在申报范围。将主要代表作品及证明材料合并为一份PDF上传，内容包括论文或著作（论文包括出版期刊封面、目录页、版权页、正文，以外文形式发表的论文，需有中文题目及中文简介）；证明材料（如检索收录情况、被引用次数、会议交流的证明材料、有关部门提供的鉴定意见和取得效益的证明等能证明成果价值的相关证明材料）；②申报表打印并签字盖章后扫描上传系统。
          <br />
          <br />
