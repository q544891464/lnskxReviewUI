    ...
    <el-row>
      <el-col v-if="$perms('system_apply_user')">
        ...
        <div class="spanclasscontent">
          1、点击左侧《创建申请表》菜单栏进入论文信息填报页面→填写信息并提交→保存成功→点击左侧《上传申请表》菜单栏进入论文列表页→根据页面提示进行申请表的下载、签字盖章并回传→申报结束
          <br />
          <br />
          2、提交材料注意事项：①将论文及证明材料合并为一份PDF上传，内容包括论文（包括出版期刊封面、目录页、版权页、正文，以外文形式发表的论文，需有中文题目及中文简介）；证明材料（如检索收录情况、被引用次数、会议交流的证明材料、有关部门提供的鉴定意见和取得效益的证明等能证明成果价值的相关证明材料）；②申报表打印并签字盖章后扫描上传系统。
          <br />
          <br />
