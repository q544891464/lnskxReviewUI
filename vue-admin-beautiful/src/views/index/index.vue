<template>
  <div class="col-auto">
    ...
    <div class="spanclasscontent">
      1、申报人登录http://42.101.40.191:8088/→进入学术论文奖系统进行网上填报→通过系统打印填报好的纸版申报表→在学术诚信承诺书上签字→将申报个报送所在单位审核→合格后加盖单位公章或科技部门公章→将签字、盖章后申报表扫描PDF上传→上传学术论文奖系统。<br>
      <br>
      2、提交材料：上传PDF电子版论文（包括出版期刊封面、目录页、版权页、正文，以外文形式发表的论文，需有中文题目及中文简介）；证明材料上传（如检索收录情况、被引用次数、会议交流的证明材料、有关部门提供的鉴定意见和取得效益的证明等能证明成果价值的相关证明材料）；申报表打印并签字盖章后扫描上传系统。<br>
      <br>
